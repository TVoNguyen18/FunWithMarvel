...
// let movieListCopy =`<h1>Movies</h1>`;
// $("#display-area").append(movieListCopy);
//
// for (let i = 0; i < movieList.length; i++) {
//   movieListCopy = `<p>${movieList[i]}</p>`;
//   $("#display-area").append(movieListCopy);
// }
//
// let movieIronMan = {
...
// `
//
// $("#display-area").append(ironManDetails);

let movieListDetailedCopy = [
  {
    timelinePosition: 1,
...
//   let movieDetails = `
//   <div class="movieSquare"><h6>${movieListDetailed[i]["title"]}</h6>
//   <img class="posters" src=${movieListDetailed[i]["moviePoster"]}>
//   <p>Rotten Tomatoes Rating: ${movieListDetailed[i]["rottenTomatoes"]}</p>
//   </div>`
//   $(".navPage").append(movieDetails);
// }

for (let i = 0; i < movieListDetailed.length; i++) {
  let d = Date.parse(movieListDetailedCopy[i]["releaseDate"]);
  movieListDetailedCopy[i]["milliTime"] = d;
}
...
function bubbleSort(a, b) {
  ...
  console.log(a);
  console.log(a["milliTime"]);
  console.log(b);
  console.log(b["milliTime"]);
  if (a["milliTime"] > b["milliTime"]) {
    tmp = a;
...
for (i = 0; i < movieListDetailedCopy.length; i++) {
  for (j = i + 1; j < movieListDetailedCopy.length; j++) {
    if (j != i) {
      let returnArray;
      returnArray = bubbleSort(movieListDetailedCopy[i], movieListDetailedCopy[j]);
      console.log("This is returnArray")
      console.log(returnArray);
      movieListDetailedCopy[i] = returnArray[0];
      movieListDetailedCopy[j] = returnArray[1];
      console.log("This is i");
      console.log(movieListDetailedCopy[i]);
      console.log("This is j")
      console.log(movieListDetailed[j]);
      console.log("This is the array of objects: ");
      console.log(movieListDetailedCopy);
      debugger;
    } else {
      console.log("NAH!!!");
    }
...
function goHome() {
  ...
  let homeContent = `
    <div class="navPage">
    <h1>Hi, this is boring, go to the other tabs.</h1>
      </div>
  `
...
function sortByMCUTimeline() {
  ...
  for (let i = 0; i < movieListDetailed.length; i++) {
    ...
    <div class="movieSquare"><h6>${movieListDetailed[i]["title"]}</h6>
    <img class="posters" src=${movieListDetailed[i]["moviePoster"]}>
    <p>${movieListDetailed[i]["timelinePosition"]}</p>
    </div>`
    $("#mcu").append(movieDetails);
  }
}
...
function sortByReleaseDate() {
  ...
  for (let i = 0; i < movieListDetailed.length; i++) {
    let movieDetails = `
    <div class="movieSquare"><h6>${movieListDetailedCopy[i]["title"]}</h6>
    <img class="posters" src=${movieListDetailedCopy[i]["moviePoster"]}>
    <p>Rotten Tomatoes: ${movieListDetailedCopy[i]["rottenTomatoes"]}</p>
    </div>`
    $("#release").append(movieDetails);
  }
}
